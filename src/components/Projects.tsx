        ...
        >
            ...
            >
                ...
                <div className="flex flex-col flex-grow p-8 -mt-6 relative z-10">
                    ...
                    <div className="mb-6">
                        <span className="text-[10px] tracking-[0.3em] uppercase text-white/60 mb-2 block font-bold">{project.category}</span>
                        <h3 className="text-2xl font-bold tracking-tight mb-3 group-hover:text-white transition-colors">{project.title}</h3>
                        <p className="text-white/70 text-sm leading-relaxed font-normal line-clamp-3">{project.description}</p>
                    </div>
...
export default function Projects() {
    return (
        <div className="relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 py-20 pb-40 relative z-10">
                ...
                <div id="skills-centering-view">
                    <div id="skills" className="max-w-4xl mx-auto mb-20 text-center">
                        <motion.span
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
